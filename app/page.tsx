    ...
    <div className="flex flex-col bg-gray-50" style={{ height: '100dvh' }}>
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="absolute z-[100]" style={{
          top: realtimeNotifications.length > 0 ? '20px' : '10px',
          left: '50%',
          ...
          <div className="relative bg-white rounded-full shadow-sm" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
            ...
            <input
              ...
              disabled={!!(selectedShop || selectedProduct || showReviewModal || showAvatarSelect || showMissionsModal)}
      ...
      {showMissionsModal && profile?.role === 'user' && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl p-5 animate-slideUp w-full max-w-sm max-h-[90vh] overflow-y-auto">
            ...
            {currentMissionsPage === 0 && (
              <div className="space-y-3">
                <div className="bg-orange-50 rounded-lg p-3 border border-orange-100">
                  <p className="text-xs font-semibold text-gray-900 mb-1.5">📌 구조 포인트란?</p>
                ...
                <div>
                  <p className="text-xs font-semibold text-gray-900 mb-2">📋 오늘의 구조 미션</p>
                  <div className="space-y-2">
            ...
            {currentMissionsPage === 1 && (
              <div className="space-y-3">
                <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
                  <p className="text-xs font-semibold text-gray-900 mb-2">⭐ 레벨 & 랭킹</p>
                ...
                <div className="bg-purple-50 rounded-lg p-3 border border-purple-100">
                  <p className="text-xs font-semibold text-gray-900 mb-1.5">🏆 월간 최고 구조대원</p>
                  <p className="text-xs text-gray-700 mb-2">매월 포인트가 가장 많은 구조대원을 선발합니다!</p>
                  <p className="text-[10px] text-gray-600 mb-2 p-1.5 bg-white/60 rounded border border-purple-200">
                    💡 현재는 시, 군 단위로 랭킹을 반영하고 있습니다. 구조대원이 많아지면 동 단위로 변경 예정입니다
                  </p>
                  <div className="space-y-1.5 text-xs">
                    <div className="flex items-center gap-2 text-gray-700">
                      <span className="min-w-fit">1위</span>
                      <span className="flex-1 border-b border-dotted border-gray-300"></span>
                      <span className="font-semibold min-w-fit">상품 증정 🎁</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-700">
                      <span className="min-w-fit">2위</span>
                      <span className="flex-1 border-b border-dotted border-gray-300"></span>
                      <span className="font-semibold min-w-fit">포인트 20P 🎁</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-700">
                      <span className="min-w-fit">3위</span>
                      <span className="flex-1 border-b border-dotted border-gray-300"></span>
                      <span className="font-semibold min-w-fit">포인트 10P 🎁</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-center gap-1.5 my-3">
              <div className={`h-1 rounded-full transition-all ${currentMissionsPage === 0 ? 'w-5 bg-rescue-orange' : 'w-1 bg-gray-300'}`}></div>
              <div className={`h-1 rounded-full transition-all ${currentMissionsPage === 1 ? 'w-5 bg-rescue-orange' : 'w-1 bg-gray-300'}`}></div>
            </div>
            ...
            <div className="flex gap-1.5">
              {currentMissionsPage > 0 && (
                <button
                  ...
                  className="flex-1 py-2.5 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 transition-colors text-xs"
                >
                  ← 이전
                </button>
              )}
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 transition-colors text-xs"
              >
                오늘 하루 보지 않기
              </button>
              <button
                onClick={() => setShowMissionsModal(false)}
                className="flex-1 py-2.5 bg-rescue-orange text-white font-semibold rounded-lg hover:bg-orange-600 transition-colors text-xs"
              >
                확인했어요
              </button>
            </div>
